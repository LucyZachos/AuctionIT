<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home_page_loggedin.aspx.cs" Inherits="AuctionIT.Home_page_loggedin" %>
    ...
    <form id="form1" runat="server" style="border: thin none #F4F4F4;">
        <asp:Panel ID="Panel1" runat="server">
            <div class="auto-style5">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:HyperLink ID="HyperLinkAbout" runat="server" NavigateUrl="~/About_logged_in_page.aspx" style="color: #FF3300; font-weight: 700; font-size: large; text-decoration: underline; font-family: 'Arial Black'">About us</asp:HyperLink>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class="auto-style3"><strong><span class="auto-style6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></strong></span>
        <p>
            <asp:Image ID="ImageHomeSlogan" runat="server" Height="470px" ImageUrl="~/Images/car and log.png" Width="869px" />
        </p>
        <asp:Panel ID="Panel2" runat="server">
            <strong><span class="newStyle3"><span class="auto-style16">How it works</span><br class="auto-style18" />
            </span></strong><span class="newStyle3"><span class="auto-style26">
            ...
            <asp:Panel ID="Panel4" runat="server">
                ...
                <asp:HyperLink ID="HyperLinkSell2" runat="server" CssClass="auto-style18" NavigateUrl="~/BuySell.aspx">Sell a car</asp:HyperLink>
            ...
            <asp:Panel ID="Panel3" runat="server">
                ...
                <asp:HyperLink ID="HyperLinkBuy2" runat="server" style="font-family: Arial; font-size: medium; text-decoration: underline; color: #0000CC" NavigateUrl="~/BuySell.aspx">Buy a car</asp:HyperLink>
